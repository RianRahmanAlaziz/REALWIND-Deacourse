...
function CardMedium({ bgImg, title, onClick }) {
    return (
        <button className='relative h-34 w-34 flex flex-col justify-end bg-cover bg-center text-white shadow-lg rounded-2xl max-md:h-28 max-md:w-28'
            onClick={onClick}>
            <img src={bgImg} alt={title} className='h-full w-full object-cover transition-transform duration-300 ease-in-out hover:scale-105' />
